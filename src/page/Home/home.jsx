...
const Home = () =>{
    ...
    const handleSubmit =(e)=>{
        ...
        console.log(Name,birthDate, Experience,Department,Address,EmployeeID,Salary,Destination,11);
        axios.post('http://localhost:5000/Employee',{Name,birthDate, Experience,Department,Address,EmployeeID,Salary,Destination})
        .then(
